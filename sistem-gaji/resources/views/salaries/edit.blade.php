    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('salaries.update', $salary) }}" id="salaryForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="period" class="block mt-1 w-full" type="text" name="period" :value="old('period', $salary->period)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="base_salary" class="block mt-1 w-full" type="number" name="base_salary" :value="old('base_salary', $salary->base_salary)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="allowance" class="block mt-1 w-full" type="number" name="allowance" :value="old('allowance', $salary->allowance)" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="deduction" class="block mt-1 w-full" type="number" name="deduction" :value="old('deduction', $salary->deduction)" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="total_salary" class="block mt-1 w-full bg-gray-100" type="number" name="total_salary" :value="old('total_salary', $salary->total_salary)" readonly />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="pay_date" class="block mt-1 w-full" type="date" name="pay_date" :value="old('pay_date', $salary->pay_date->format('Y-m-d'))" required />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="notes" name="notes" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('notes', $salary->notes) }}</textarea>
